...
class Trainer(object):
    ...
    def train(self, args, train_iter_fct, train_steps, valid_iter_fct=None, valid_steps=-1):
        """
    ...
    def validate(self, args, valid_iter, step=0):
        """ Validate model.
    ...
    def test(self, args, test_iter, step, cal_lead=False, cal_oracle=False):
        """ Validate model.
            valid_iter: validate data iterator
        Returns:
            :obj:`nmt.Statistics`: validation loss statistics
    ...
    def _maybe_return_stats(self, step, num_steps, learning_rate,
                               report_stats):
        if self.report_manager is not None:
            return self.report_manager.return_stats(
                step, num_steps, learning_rate, report_stats)
