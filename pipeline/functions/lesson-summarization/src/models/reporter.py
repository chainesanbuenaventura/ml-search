...
class ReportMgr(ReportMgrBase):
    ...
    def _report_training(self, step, num_steps, learning_rate,
        ...
        """
        accuracy, ppl, xent, lr = report_stats.output(step, num_steps,
    ...
    def return_stats(self, step, num_steps, learning_rate,
                         report_stats):
        accuracy, ppl, xent, lr = report_stats.output(step, num_steps,
                            learning_rate, self.start_time)
        return accuracy, ppl, xent, lr
